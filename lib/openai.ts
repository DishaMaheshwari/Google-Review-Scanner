...
- Real Google reviews from happy customers are short: match that. Aim for 30 to 40 words — one or two sentences, never three. Longer is not better here.
...
const STYLE_DIRECTIVES = [
  "One sentence, 30 to 40 words. Plain and understated.",
  "Two short sentences totalling 30 to 40 words: what was needed, then how it went.",
  "One flowing sentence of about 35 words, naming the service plainly.",
  "Lead with the single thing the customer liked most, in one sentence of 30 to 40 words.",
  "Matter-of-fact and practical. No adjective stronger than 'good'. One sentence, 30 to 40 words.",
  "Slightly informal, the way someone types on a phone. 30 to 40 words.",
  "Two short sentences totalling 30 to 40 words: how it went, then whether you'd use them again.",
  "Start with the outcome, then give one concrete reason for it, in two short sentences totalling 30 to 40 words.",
];
